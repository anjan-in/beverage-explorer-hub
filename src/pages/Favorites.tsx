  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">My Cabinet</h1>
        <p className="text-sm text-gray-500 mb-8">Your curated collection of saved dynamic recipes.</p>

        {favorites.length === 0 ? (
          <div className="bg-white border border-gray-200 rounded-2xl p-12 text-center max-w-md mx-auto shadow-sm mt-8">
            <span className="text-4xl">🍹</span>
            <h2 className="text-xl font-bold text-gray-800 mt-4 mb-2">Your cabinet is empty</h2>
              ...
              >
                ...
                <div className="p-4 flex-grow flex flex-col justify-between">
                  <div>
                    ...
                    <h2 className="text-lg font-bold text-gray-800 mt-1 mb-4 line-clamp-1">{drink.strDrink}</h2>
                  </div>
